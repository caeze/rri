...
class Constants {
    ...
    // recurring tasks
    const RECURRING_TASKS = ['cleanupLogs' => 'CLEANUP_LOGS', 'removeToBeDeletedUsers' => 'REMOVE_TO_BE_DELETED_USERS', 'removeToBeDeletedArticles' => 'REMOVE_TO_BE_DELETED_ARTICLES', 'checkForExpiredBiddings' => 'CHECK_FOR_EXPIRED_BIDDINGS'];
    const RECURRING_TASKS_TIMEFRAMES = ['cleanupLogs' => '1', 'removeToBeDeletedUsers' => '1', 'removeToBeDeletedArticles' => '1', 'checkForExpiredBiddings' => '1'];
    const RECURRING_TASKS_UNITS = ['cleanupLogs' => 'WEEKS', 'removeToBeDeletedUsers' => 'WEEKS', 'removeToBeDeletedArticles' => 'WEEKS', 'checkForExpiredBiddings' => 'DAYS'];
