                ...
                <body>
                    <div id="container">
                        <div id="header">
                            <div id="headerLogo">
                                <a href="articles.php">
                                    <img src="static/img/fsiLogo.png' . $GLOBALS['VERSION_STRING'] . '" style="height: 30px;" alt="fsi logo">
                                </a>
                            </div>
                            <div id="headerTitle">
                            ' . $title . '
                            ...
                            <div id="headerMenues">
                                <div id="helpMenu" class="dropdown">
                                    <img src="static/img/question.png' . $GLOBALS['VERSION_STRING'] . '" style="height: 30px;" alt="help">
                                    <img src="static/img/arrowDown.png' . $GLOBALS['VERSION_STRING'] . '" style="height: 17px;" alt="arrow down">
                                ...
                                <div id="userMenu" class="dropdown">
                                    <img src="static/img/person.png' . $GLOBALS['VERSION_STRING'] . '" style="height: 30px;" alt="user menu">
                                    <img src="static/img/arrowDown.png' . $GLOBALS['VERSION_STRING'] . '" style="height: 17px;" alt="arrow down">
                                    <div class="dropdown-content">
