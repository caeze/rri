<?php
    ...
    echo $header->getHeader($i18n->get('title'), $i18n->get('recurringTasks'), array('button.css', 'searchableTable.css'));
    ...
    for ($i = 0; $i < count($recurringTasksData); $i++) {
        ...
        $row[] = '<a id="styledButton" href="?run=' . $id . '"><img src="static/img/run.png" style="height: 24px; vertical-align: middle;">&nbsp;&nbsp;' . $i18n->get('runNow') . '</a>';
        $data[] = $row;
    }
